...
import GenreForm from "../../components/Modal/GenreModal/GenreForm";
...
export default function EnhancedTable() {
  ...
  const rows = useSelector((state) => state.genres.genres);
  ...
  const getGenreEditing = (id) => {
    dispatch(actions.actGetGenreRequest(id));
  ...
  const searchGenreQuery = (e) => {
    e.preventDefault();
    const filter = `filter={"name": {"like": "${genreFilter.name}"}}`;
    dispatch(actions.actFetchDataGenresFilterRequest(filter));
  };
                      ...
                      >
                        <div class="form-group mb-2 mr-5">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              setGenreFilter({...genreFilter, name: e.target.value});
                            }}
                          ></input>
                        </div>
                                  ...
                                  <TableRow>
                                    ...
                                    <TableCell align="center">
                                      <button
                                        type="button"
                                        className="btn btn-warning"
                                        onClick={() => getGenreEditing(row.id)}
                                      >
