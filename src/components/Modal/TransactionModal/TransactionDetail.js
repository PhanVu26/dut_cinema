      ...
      <div>
        <form>
          ...
          >
            ...
            <Modal.Body>
              <div className="row">
                <div className="col-md-6 col-lg-6 movie-details">
                  ...
                  <table className="table">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>
                            {transaction.ticket?.seat.row +
                              transaction.ticket?.seat.column}
                          </span>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <span>
                            {transaction.ticket?.seat.room.roomNumber}
                          </span>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <span>
                            {transaction.ticket?.seat.room.cinema.name}
                          </span>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <span>
                            {
                              transaction.ticket?.showtime.startTime.split(
                                "T"
                              )[0]
                            }
                          </span>
                      ...
                      <tr>
                        ...
                        <td>
                          <span>
                            {transaction.ticket?.showtime.startTime
                              .split("T")[1]
                              .slice(0, 5)}
                          </span>
                        </td>
