    ...
    return (          
        <div className="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top sidebar-side">
            ...
            <ul className="navbar-nav mt-4 flex-column ">
                ...
                <li className="nav-item">
                    <NavLink to="/showtime-manager/profile" className="nav-link text-white p-2 mb-2 sidebar-link"><i
                        className="fas fa-user fa-lg mr-4 text-white"></i>Profile</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink to="/showtime-manager/movie-showtimes" className="nav-link text-white p-2 mb-2 sidebar-link"><i
                        className="fas fa-envelope fa-lg mr-4 text-white"></i>Movie showtimes</NavLink>
                </li>
                <li className="nav-item">
